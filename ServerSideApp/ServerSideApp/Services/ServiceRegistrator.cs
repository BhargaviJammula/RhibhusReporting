...
using ServerSideApp.Services.Reporting;
using System;
using System.IO;
...
namespace ServerSideApp.Services
{
    ...
    {
        public static IServiceCollection AddCommonServices(IServiceCollection services, string contentRootPath = "C:\\code\\Columbia Asia\\pocs\\DevExpressReporting\\ServerSideApp\\ServerSideApp")
        {
